...
namespace BlogAppService.Infrastructure.Persistance.DIContainer
{
    public static class DIServiceRegistration
    {
        public static void AddDIServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IArticleRelishReadRepository, ArticleRelishReadRepository>();
            services.AddScoped<IArticleRelishWriteRepository, ArticleRelishWriteRepository>();
